...
class RareData {
    ...
    static encryptData = async (toPubKeyHex, data, fromPrivKeyHex) => {
        ...
        const fromPubKey = secp256k1.getPublicKey(fromPrivKey, true);
        const ecdhKey = secp256k1.getSharedSecret(fromPrivKey, toPubKeyHex, true);
    ...
    static decryptData = async (privKeyHex, encryptedData) => {
        ...
        const ecdhKey = secp256k1.getSharedSecret(privKeyHex, encryptedData.slice(0, 66), true);
