...
const LightningAuth_js_1 = __importDefault(require("./enums/LightningAuth.js"));
class LightningPayment {
    static getLNDAdmin = async () => {
        const { lnd } = lightning.authenticatedLndGrpc({
            cert: LightningAuth_js_1.default.TLS,
            macaroon: LightningAuth_js_1.default.Macaroon,
            socket: LightningAuth_js_1.default.Socket,
        });
